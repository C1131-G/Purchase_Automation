...
import { cancelCreditNote } from "@/modules/ap-credit-memo/ap-credit-memo.update-cancel.mutations";
...
describe("cancelCreditNote", () => {
  ...
  it("posts cancel to Service Layer", async () => {
    ...
    expect(request).toHaveBeenCalledWith("sess-1", "POST", "/PurchaseCreditNotes(42)/Cancel");
