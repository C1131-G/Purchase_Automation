...
import { cancelPayment } from "@/modules/outgoing-payment/outgoing-payment.update-cancel.mutations";
...
describe("cancelPayment", () => {
  ...
  it("posts cancel to Service Layer", async () => {
    ...
    expect(request).toHaveBeenCalledWith("sess-1", "POST", "/VendorPayments(42)/Cancel");
