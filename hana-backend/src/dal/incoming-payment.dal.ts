...
export const getPayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    logger.info({ id, msg: "Fetching Incoming Payment detail" });
...
export const getPaymentByDocNum = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    logger.info({ docNum, msg: "Fetching Incoming Payment detail by DocNum" });
...
export const createPayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    logger.info({ docNum: result.DocNum, msg: "Incoming Payment Created" });
...
export const updatePayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    logger.info({ id, msg: "Updating Incoming Payment" });
...
export const cancelPayment = async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    logger.info({ id, msg: "Cancelling Incoming Payment" });
