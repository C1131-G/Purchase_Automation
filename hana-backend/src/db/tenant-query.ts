// Tenant query helper: Provides centralized access to tenant-specific TypeORM repositories and raw query execution.
...
// This abstract away the multi-tenant data source logic from the rest of the data-access code.
