...
export const GRPOSchema = new EntitySchema<GRPO>({
  ...
  indices: [
    { columns: ["docNum"], name: "IDX_OPDN_DOCNUM" },
    { columns: ["docDate"], name: "IDX_OPDN_DOCDATE" },
    { columns: ["cardCode"], name: "IDX_OPDN_CARDCODE" },
    { columns: ["cardName"], name: "IDX_OPDN_CARDNAME" },
  ],
  name: "GRPO",
  tableName: "OPDN",
});
