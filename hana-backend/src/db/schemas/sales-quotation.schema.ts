...
export const SalesQuotationSchema = new EntitySchema<SalesQuotation>({
  ...
  indices: [
    { columns: ["docNum"], name: "IDX_OQUT_DOCNUM" },
    { columns: ["docDate"], name: "IDX_OQUT_DOCDATE" },
    { columns: ["cardCode"], name: "IDX_OQUT_CARDCODE" },
    { columns: ["cardName"], name: "IDX_OQUT_CARDNAME" },
  ],
  name: "SalesQuotation",
  tableName: "OQUT",
});
