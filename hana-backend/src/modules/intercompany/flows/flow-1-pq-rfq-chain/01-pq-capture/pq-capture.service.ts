...
export const createPqCaptureService = (deps?: {
  ...
  return {
    capture: async (input) => {
      ...
      const invalid = detectInvalidPqInput(input);
      if (invalid) {
        logFlowStep(SCOPE, {
          step: 3,
          total: 18,
...
export const pqDraftCaptureService = createPqCaptureService();
