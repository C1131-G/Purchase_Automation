...
router.get("/by-doc-num/:docNum", salesQuotationController.getSalesQuotationByDocNum);
...
router.patch("/:id", salesQuotationController.updateSalesQuotation);
...
router.post("/:id/cancel", salesQuotationController.cancelSalesQuotation);
