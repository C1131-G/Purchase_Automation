...
/**
 * Template for mail notifications sent to Approver for new  request
 * @param {String} moduleName
 * @param {String} originatorName
 * @param {String} approverName
 * @param {String} draftNum
 * @param {String} draftStatus
 */
const getMailBody = (moduleName, originatorName, approverName, draftNum, draftStatus) => {
  return `
  <!DOCTYPE html>
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    padding: 0'><span>${moduleName} </span></h1>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
    ...
    padding-bottom: 9px; padding-left: 18px;' valign="top">
    Hi ${originatorName}, <br /><br />
    Your ${moduleName} has been ${draftStatus} by <b>${approverName}</b>. Please find below next recommended action.
    <br /><br />
                                  </td>
                                </tr>
                              </tbody>
    ...
    Next Action - 
    ${draftStatus === "APPROVED" ? "Review" : "Review and resubmit your request"}</h3>
    ...
    ${draftStatus === "APPROVED" ? "" : "to review the 'Rejection Reason' posted by your approver, modify the request and resubmit it"}.
                                  </p>
                                </td>
                              </tr>
                            </table>
...
module.exports = { subject, getMailBody };
