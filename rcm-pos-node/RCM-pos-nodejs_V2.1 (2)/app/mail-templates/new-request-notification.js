 ...
 * @param {String} moduleName   Stock Transfer Request, Stock Transfer
 * @param {*} originatorName
 * @param {*} draftNum
 */
const getMailBody = (moduleName, originatorName, draftNum) => {
  return `
  <!DOCTYPE html>
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
      ...
      <title>${moduleName} notification</title>
      <!--[if !mso]>
          <!-- -->
    ...
    line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
    padding-bottom: 9px; padding-left: 18px;' valign="top">
    <b>${originatorName}</b> has submitted a ${moduleName}.
    ...
    #FFFFFF;">Request no.: ${draftNum}</span>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
