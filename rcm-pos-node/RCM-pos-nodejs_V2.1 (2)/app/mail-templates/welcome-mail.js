const subject = "POS - Welcome mail";

const getMailBody = (adminUser, username, password) => {
  return `
  <!DOCTYPE html>
  <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    padding: 0'><span>Welcome ${username}!</span></h1>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
    ...
    line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
    padding-bottom: 9px; padding-left: 18px;' valign="top">
    <b>${adminUser}</b> has invited you to POS, a Point of Sale app to streamline your tasks. Please use the below temporary password to sign in. 
                                      <br></br>
                                  </td>
                                </tr>
                              </tbody>
