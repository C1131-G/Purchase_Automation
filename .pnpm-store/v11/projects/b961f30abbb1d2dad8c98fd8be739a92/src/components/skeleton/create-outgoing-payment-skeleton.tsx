...
export function CreateOutgoingPaymentSkeleton() {
  return (
    <div className="w-full bg-zinc-50 p-3 pb-20">
      {/* Breadcrumb bar — matches CreatePageWrapper exactly */}
      <div className="mb-4 inline-flex flex-wrap items-center gap-2 whitespace-nowrap rounded-2xl border border-zinc-200/80 bg-white/85 px-4 py-2 text-xs font-medium tracking-normal text-zinc-600 shadow-[0_10px_24px_-18px_rgba(15,23,42,0.32)] backdrop-blur-sm">
