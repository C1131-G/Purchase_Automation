...
const PurchaseQuotationLineSchema = z.object({
  ...
  priceBefDi: z.coerce.number().min(0).optional(),
...
export const CreatePurchaseQuotationSchema = z.object({
  ...
  lines: z.array(PurchaseQuotationLineSchema).min(1),
  isDraft: z.boolean().optional(),
  draftDocEntry: z.coerce.number().int().optional(),
});

export const UpdatePurchaseQuotationSchema = CreatePurchaseQuotationSchema.partial();

export const PurchaseQuotationListQuerySchema = z.object({
