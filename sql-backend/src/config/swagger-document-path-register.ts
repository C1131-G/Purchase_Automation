...
export const registerDocumentPaths = (options: DocumentPathOptions) => {
  ...
  registerPath(`/${entityPath}`, "get", {
    ...
    description: `Retrieves a paginated list of ${entityLabel} documents with filtering and sorting.`,
    tags: [entityLabel],
  ...
  registerPath(`/${entityPath}/{id}`, "get", {
    ...
    description: `Retrieves detailed information for a specific ${entityLabel}.`,
    tags: [entityLabel],
    responses: jsonResponses({
  ...
  if (supportsUpdate) {
    registerPath(`/${entityPath}/{id}`, "patch", {
      ...
      description: `Updates an existing ${entityLabel} document.`,
      tags: [entityLabel],
      ...(updateSchema
  ...
  // Matches Express: router.get("/docnums", ...)
  registerPath(`/${entityPath}/docnums`, "get", {
    ...secured,
    operationId: `list${id}DocNums`,
    summary: `${entityLabel} doc number lookup`,
    description: `Document number suggestions for ${entityLabel} lookup fields.`,
    tags: [entityLabel],
    responses: jsonResponses({
      successDescription: "Doc numbers list.",
    }),
  });
};
