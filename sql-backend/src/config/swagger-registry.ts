...
/** Paths are relative to servers[0].url (/api/v1) — do not prefix /api/v1 here. */
...
/** Register a Zod schema into components/schemas (idempotent name). */
...
/** Build a JSON request body from a Zod schema (registered or inline). */
