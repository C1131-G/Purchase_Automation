...
export const getById: RequestHandler = async (req, res, next) => {
  try {
    const result = await apInvoiceService.getByDocNum(Number(req.params.id));
...
export const create: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .json({ data: toPascalCase(result), message: "AP Invoice created", success: true });
  } catch (e) {
    next(e);
  }
};
...
export const update: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: toPascalCase(result), message: "AP Invoice updated", success: true });
  } catch (e) {
    next(e);
  }
};
...
export const cancel: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: toPascalCase(result), message: "AP Invoice cancelled", success: true });
  } catch (e) {
    next(e);
  }
};
...
export const reopen: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: toPascalCase(result), message: "AP Invoice reopened", success: true });
  } catch (e) {
    next(e);
  }
};
