...
export const create: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .json({ data: toPascalCase(result), message: "Outgoing payment created", success: true });
  } catch (e) {
    next(e);
  }
};
export const update: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: toPascalCase(result), message: "Outgoing payment updated", success: true });
  } catch (e) {
    next(e);
  }
};
export const cancel: RequestHandler = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: toPascalCase(result), message: "Outgoing payment cancelled", success: true });
  } catch (e) {
    next(e);
  }
};
