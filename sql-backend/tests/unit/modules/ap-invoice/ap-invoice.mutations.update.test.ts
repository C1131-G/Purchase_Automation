...
vi.mock("@/modules/ap-invoice/ap-invoice.repository", () => ({
  apInvoiceRepository: {
...
vi.mock("@/modules/ap-invoice/ap-invoice.queries", () => ({
...
import { cancel } from "@/modules/ap-invoice/ap-invoice.mutations.update";

describe("cancel ap-invoice", () => {
  beforeEach(() => {
    findById.mockReset();
