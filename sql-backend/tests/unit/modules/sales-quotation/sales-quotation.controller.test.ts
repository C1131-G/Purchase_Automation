...
vi.mock("@/modules/sales-quotation/sales-quotation.service", () => ({
...
import * as controller from "@/modules/sales-quotation/sales-quotation.controller";
...
describe("sales-quotation controller", () => {
  beforeEach(() => {
    getList.mockReset();
    create.mockReset();
    cancel.mockReset();
