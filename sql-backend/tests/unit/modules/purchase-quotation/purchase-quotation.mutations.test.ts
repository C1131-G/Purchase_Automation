...
vi.mock("@/modules/purchase-quotation/purchase-quotation.repository", () => ({
...
vi.mock("@/modules/purchase-quotation/purchase-quotation.queries", () => ({
...
import { cancel } from "@/modules/purchase-quotation/purchase-quotation.mutations";

describe("cancel purchase-quotation", () => {
  beforeEach(() => {
    findById.mockReset();
