...
vi.mock("@/modules/purchase-quotation/purchase-quotation.service", () => ({
...
import * as controller from "@/modules/purchase-quotation/purchase-quotation.controller";
...
describe("purchase-quotation controller", () => {
  beforeEach(() => {
    getList.mockReset();
    create.mockReset();
    cancel.mockReset();
