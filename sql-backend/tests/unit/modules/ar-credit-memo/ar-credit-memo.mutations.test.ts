...
vi.mock("@/modules/ar-credit-memo/ar-credit-memo.repository", () => ({
  arCreditMemoRepository: {
...
vi.mock("@/modules/ar-credit-memo/ar-credit-memo.queries", () => ({
...
import { cancel } from "@/modules/ar-credit-memo/ar-credit-memo.mutations";

describe("cancel ar-credit-memo", () => {
  beforeEach(() => {
    findById.mockReset();
