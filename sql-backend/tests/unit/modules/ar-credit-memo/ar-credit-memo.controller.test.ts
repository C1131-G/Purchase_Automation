...
vi.mock("@/modules/ar-credit-memo/ar-credit-memo.service", () => ({
  arCreditMemoService: {
...
import * as controller from "@/modules/ar-credit-memo/ar-credit-memo.controller";
...
describe("ar-credit-memo controller", () => {
  beforeEach(() => {
    getList.mockReset();
    create.mockReset();
    cancel.mockReset();
