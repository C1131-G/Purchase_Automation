...
vi.mock("@/modules/ap-credit-memo/ap-credit-memo.repository", () => ({
  apCreditMemoRepository: {
...
vi.mock("@/modules/ap-credit-memo/ap-credit-memo.queries", () => ({
...
import { cancel } from "@/modules/ap-credit-memo/ap-credit-memo.mutations";

describe("cancel ap-credit-memo", () => {
  beforeEach(() => {
    findById.mockReset();
