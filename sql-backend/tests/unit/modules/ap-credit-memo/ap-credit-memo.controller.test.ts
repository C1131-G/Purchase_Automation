...
vi.mock("@/modules/ap-credit-memo/ap-credit-memo.service", () => ({
  apCreditMemoService: {
...
import * as controller from "@/modules/ap-credit-memo/ap-credit-memo.controller";
...
describe("ap-credit-memo controller", () => {
  beforeEach(() => {
    getList.mockReset();
    create.mockReset();
    cancel.mockReset();
