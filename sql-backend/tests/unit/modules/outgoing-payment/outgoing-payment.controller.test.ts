...
vi.mock("@/modules/outgoing-payment/outgoing-payment.service", () => ({
...
import * as controller from "@/modules/outgoing-payment/outgoing-payment.controller";
...
describe("outgoing-payment controller", () => {
  beforeEach(() => {
    getList.mockReset();
    create.mockReset();
    cancel.mockReset();
