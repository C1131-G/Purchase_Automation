...
export const useTableOrderStore = create<OrderStore>((set) => ({
    ...
    resetOrder: (tableId, defaultOrder) => set((prev) => ({
...
export const useSetOrderAction = () =>
    useTableOrderStore((state) => state.setOrder)

export const useInitOrderAction = () =>
    useTableOrderStore((state) => state.initOrder)

export const useResetOrderAction = () =>
    useTableOrderStore((state) => state.resetOrder)
