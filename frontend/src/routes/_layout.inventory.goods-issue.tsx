  ...
  return (
    <div className="flex items-center justify-center h-full w-full p-6">
      <div className="bg-white rounded-xl border border-zinc-100 p-8 max-w-md w-full shadow-xs text-center">
        <h2 className="text-xl font-bold text-zinc-900 mb-2">Goods Issue</h2>
        <p className="text-zinc-500 text-sm">
          This section is a placeholder and will display the Goods Issue document entry or listing
          in the future.
        </p>
      </div>
    </div>
