...
export function IncomingPaymentTable() {
  ...
  const columnFilters = useMemo<ColumnFiltersState>(() => {
    ...
    if (searchParams.CounterRef) built.push({ id: "CounterRef", value: searchParams.CounterRef });
  ...
  const table = useReactTable<IncomingPaymentListItem>({
    ...
    onColumnFiltersChange: (updater) => {      const next = typeof updater === "function" ? updater(columnFilters) : updater;
      ...
      const counterRefVal = nextFilters.find((f) => f.id === "CounterRef")?.value;
      ...
      navigate({
        ...
        search: (prev: IncomingPaymentSearch) => ({
          ...
          CounterRef: counterRefVal ? String(counterRefVal) : undefined,
