...
export const arCreditNoteListItemSchema = z.object({
  id: z.number(),
  DocNum: z.number(),
  DocDate: z.string(),
  CardCode: z.string(),
...
export const arCreditNoteListResponseSchema = z.object({
  success: z.boolean(),
  data: z.array(arCreditNoteListItemSchema),
  total: z.number(),
  page: z.number(),
  limit: z.number(),
  totalPages: z.number(),
...
export const arCreditNoteListParamsSchema = z.object({
