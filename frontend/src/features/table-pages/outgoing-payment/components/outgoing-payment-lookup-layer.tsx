...
export function OutgoingPaymentLookupLayer({
  ...
  const docNumSuggestionsQuery = useQuery(outgoingPaymentQueries.docNumSuggestions(undefined, 10))
  ...
  useEffect(() => {
    ...
    void queryClient.prefetchQuery(outgoingPaymentQueries.docNumSuggestions(undefined, 100))
