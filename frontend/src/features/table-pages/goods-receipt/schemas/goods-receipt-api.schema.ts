...
export const goodsReceiptListItemSchema = z.object({
  DocEntry: z.number(),
  DocNum: z.number(),
  DocDate: z.string(),
  TaxDate: z.string(),
  Comments: z.string().nullable().optional(),
  JrnlMemo: z.string().nullable().optional(),
  DocTotal: z.number(),
...
export const goodsReceiptListResponseSchema = z.object({
  data: z.array(goodsReceiptListItemSchema),
  limit: z.number(),
  page: z.number(),
  success: z.boolean(),
  total: z.number(),
...
export const goodsReceiptListParamsSchema = z.object({
