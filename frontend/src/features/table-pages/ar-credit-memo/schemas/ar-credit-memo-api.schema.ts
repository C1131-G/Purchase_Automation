...
export const ArCreditMemoListItemSchema = z.object({
  id: z.number(),
  DocNum: z.number(),
  DocDate: z.string(),
  CardCode: z.string(),
...
export const ArCreditMemoListResponseSchema = z.object({
  success: z.boolean(),
  data: z.array(ArCreditMemoListItemSchema),
  total: z.number(),
  page: z.number(),
  limit: z.number(),
  totalPages: z.number(),
...
export const ArCreditMemoListParamsSchema = z.object({
