...
export function ARInvoiceTable({
  ...
  const columnFilters = useMemo<ColumnFiltersState>(() => {
    ...
    if (searchParams.NumAtCard) built.push({ id: "NumAtCard", value: searchParams.NumAtCard });
  ...
  const table = useReactTable<ARInvoiceListItem>({
    ...
    onColumnFiltersChange: (updater) => {      const next = typeof updater === "function" ? updater(columnFilters) : updater;
      ...
      const numAtCardVal = nextFilters.find((f) => f.id === "NumAtCard")?.value;
      ...
      navigate({
        ...
        search: (prev: ARInvoiceSearch) => ({
          ...
          NumAtCard: numAtCardVal ? String(numAtCardVal) : undefined,
