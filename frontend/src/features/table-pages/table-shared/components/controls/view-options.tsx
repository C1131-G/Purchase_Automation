...
import { TableColumnOrder } from "@/features/table-pages/table-shared/components/controls/column-order";
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        ...
        className="flex h-11 items-center gap-2 rounded-xl border border-linen-200 bg-surface px-4 py-2 text-sm font-semibold text-ink-900 shadow-sm transition-all hover:bg-linen-50 hover:text-teal-700 active:scale-[0.98] normal-case tracking-normal group focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-200 focus-visible:border-teal-300 cursor-pointer"
      >
        <span>View</span>
