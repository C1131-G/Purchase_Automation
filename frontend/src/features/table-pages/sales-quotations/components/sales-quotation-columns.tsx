// SalesQuotationColumns: Column definitions (accessors, headers, cell renderers) for the sales quotation grid.
...
const columnHelper = createColumnHelper<SalesQuotationListItem>();
