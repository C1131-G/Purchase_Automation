...
import { GoodsReceiptProductTableRow } from "./goods-receipt-product-table-row";
import type { GoodsReceiptRow } from "../types/goods-receipt.types";

interface GoodsReceiptProductTableProps {
      ...
      <table className="w-full text-left text-sm text-zinc-700 min-w-[1400px]">
        <thead className="bg-zinc-50 text-[11px] font-semibold uppercase tracking-[0.12em] text-zinc-500">
          <tr>
            ...
            <th className="w-[8%] px-2 py-2 text-left">Unit Price</th>
