...
export const createColumns = () => [
    ...
    columnHelper.accessor('DocTotal', {
        ...
        filterFn: (row, columnId, filterValue) => {
            ...
            // Compare on 2-decimal precision to match rendered Doc Total values.
            const normalize2 = (n: number) => Math.round((n + Number.EPSILON) * 100) / 100
            const left = normalize2(rowValue)
            const right = normalize2(value)
